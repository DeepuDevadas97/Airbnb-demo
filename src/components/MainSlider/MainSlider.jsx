...
//       <button
//         className={`hidden swiper-button-prev-custom w-6 h-6 md:flex items-center justify-center cursor-pointer absolute right-[32px] top-[-30px] -translate-y-1/2 z-10 rounded-full border duration-300 ${
//           isBeginning
//             ? "border-gray-200"
...
//       </button>
//       <button
//         className={`hidden swiper-button-next-custom w-6 h-6 md:flex items-center justify-center cursor-pointer absolute right-0 top-[-30px] -translate-y-1/2 z-10 rounded-full border duration-300 ${
//           isEnd
//             ? "border-gray-200"
//             : "border-gray-400  bg-gray-100  hover:bg-gray-200"
//         }`}
...
//           <SwiperSlide>
//             <HomeCard key={hotel.id} data={hotel} />
//           </SwiperSlide>
//         ))}
//       </Swiper>
//     </div>
